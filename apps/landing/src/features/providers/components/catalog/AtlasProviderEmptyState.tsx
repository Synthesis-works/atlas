...
export function AtlasProviderEmptyState({ hasFilters, onClearFilters }: Props) {
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
      ...
      <h3 className="text-lg font-medium text-white mb-2">
        {hasFilters ? 'No matching providers found' : 'No providers available'}
      </h3>
      
      <p className="text-sm text-white/40 max-w-[280px] mb-6">
        {hasFilters 
          ? "We couldn't find any providers matching your current filter criteria."
          : "There are currently no AI providers registered in the workspace."}
      </p>
