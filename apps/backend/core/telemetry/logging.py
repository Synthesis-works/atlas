...
from .context import get_correlation_id, get_trace_id, get_span_id

# Keys that should be redacted from logs
SENSITIVE_KEYS = {"password", "token", "api_key", "secret", "credentials"}

def inject_context_ids(logger: logging.Logger, log_method: str, event_dict: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def redact_sensitive_data(logger: logging.Logger, log_method: str, event_dict: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def sample_debug_logs(logger: logging.Logger, log_method: str, event_dict: Dict[str, Any]) -> Dict[str, Any]:
    """
