...
from apps.backend.agent.tools.evaluation_tools import CreateEvaluationCaseTool, EvaluateRunTool, _evaluation_case_store
        ...
        evaluation_cases=[
            {
                ...
                "rubric_criteria": ["Mentions Rayleigh scattering", "Mentions blue light wavelength"],
            }
        ]
    )
