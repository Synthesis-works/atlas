...
project_benchmarks_router = APIRouter(
    prefix="/projects/{project_id}/benchmarks", tags=["Benchmarks"]
)
...
@project_benchmarks_router.post(
...
def update_benchmark(
    ...
    updated_benchmark = app_service.update_benchmark(
        benchmark_id=benchmark_id, user_id=claims.sub, user_role=user_role, data=data
    )
...
def delete_benchmark(
    ...
    app_service.delete_benchmark(benchmark_id=benchmark_id, user_id=claims.sub, user_role=user_role)
...
@benchmarks_router.post(
    "/{benchmark_id}/versions",
    response_model=APIResponse[BenchmarkVersionRead],
...
@benchmarks_router.get(
    "/{benchmark_id}/versions", response_model=APIResponse[list[BenchmarkVersionRead]]
)
...
def update_benchmark_version(
    ...
    updated = app_service.update_version(
        version_id=version_id, user_id=claims.sub, user_role=user_role, data=data
    )
