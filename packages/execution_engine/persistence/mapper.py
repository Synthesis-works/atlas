from packages.execution_engine.domain.models import Artifact, Execution, ExecutionAttempt, Lease
...
class ExecutionMapper:
    ...
    def to_domain(model: ExecutionModel) -> Execution:
        ...
        return Execution.rehydrate(
            ...
            status=model.status,
            target_model=getattr(model, "target_model", "gemini-3.5-flash-lite") or "gemini-3.5-flash-lite",
