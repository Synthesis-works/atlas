...
def test_multiple_deterministic_ordering():
    exporter = JSONLDatasetExporter()
    examples = [dummy_example("p1", "a1"), dummy_example("p2", "a2"), dummy_example("p3", "a3")]
...
def test_str_null_and_mixed_outputs():
    ...
    ex = dummy_example(
        "prompt", "null"
    )  # In TrainingExample, canonical_answer is always str safely encoded inside the extraction component!
