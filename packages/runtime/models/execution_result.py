...
class ExecutionResult(BaseModel):
    ...
    memory_used: Optional[int] = Field(None, description="Memory used during execution in MB")
    ...
    exception: Optional[str] = Field(None, description="String representation of any internal exception")
