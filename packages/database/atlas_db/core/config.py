...
class DatabaseConfig(BaseSettings):
    ...
    def async_database_url(self) -> str:
        import os
        return os.getenv("ASYNC_DATABASE_URL", f"postgresql+asyncpg://{self.POSTGRES_USER}:{self.POSTGRES_PASSWORD}@{self.POSTGRES_HOST}:{self.POSTGRES_PORT}/{self.POSTGRES_DB}")
