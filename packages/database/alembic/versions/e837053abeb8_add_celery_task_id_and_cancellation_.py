...
down_revision: str | Sequence[str] | None = "3a1cf533642c"
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("executions", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column(
                "cancellation_requested", sa.Boolean(), server_default="false", nullable=False
            )
        )
        batch_op.create_index(
            batch_op.f("ix_executions_celery_task_id"), ["celery_task_id"], unique=False
        )
