...
down_revision: Union[str, None] = '2d604cb686b3'
...
def upgrade() -> None:
    with op.batch_alter_table('datasets') as batch_op:
        ...
        batch_op.add_column(sa.Column('status', sa.String(), nullable=True, server_default='ACTIVE'))
        batch_op.create_foreign_key('fk_datasets_project_id_projects', 'projects', ['project_id'], ['id'])
        batch_op.create_foreign_key('fk_datasets_created_by_member_id_org_members', 'organization_members', ['created_by_member_id'], ['id'])
