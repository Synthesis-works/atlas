...
def upgrade() -> None:
    ...
    sa.Column('validation_status', postgresql.ENUM('PENDING', 'VALIDATED', 'FAILED', name='dataset_validation_status'), nullable=False),
    ...
    sa.Column('status', postgresql.ENUM('PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED', name='run_status'), nullable=False),
    sa.Column('started_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('completed_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.Column('type', postgresql.ENUM('LOG', 'WEIGHTS', 'FILE', name='artifact_type'), nullable=False),
