...
def upgrade() -> None:
    # 1. New Indexes
    op.create_index('ix_atlas_runs_status_created_at', 'atlas_runs', ['status', 'created_at'], if_not_exists=True)
    op.create_index('ix_atlas_runs_target_model', 'atlas_runs', ['target_model'], if_not_exists=True)
    ...
    with op.batch_alter_table('configuration_versions') as batch_op:
        batch_op.create_unique_constraint('uq_configuration_version', ['configuration_id', 'version_string'])
    with op.batch_alter_table('benchmark_versions') as batch_op:
        batch_op.create_unique_constraint('uq_benchmark_version', ['benchmark_id', 'version_string'])
    ...
    with op.batch_alter_table('benchmark_lifecycles') as batch_op:
        batch_op.drop_constraint('fk_benchmark_lifecycles_benchmark_id_benchmarks', type_='foreignkey')
    with op.batch_alter_table('benchmark_lifecycles') as batch_op:
        batch_op.create_foreign_key('fk_benchmark_lifecycles_benchmark_id_benchmarks', 'benchmarks', ['benchmark_id'], ['id'], ondelete='CASCADE')
    ...
    with op.batch_alter_table('model_outputs') as batch_op:
        batch_op.create_foreign_key('fk_model_outputs_atlas_run_id_atlas_runs', 'atlas_runs', ['atlas_run_id'], ['id'], ondelete='CASCADE')

    with op.batch_alter_table('artifacts') as batch_op:
        batch_op.drop_constraint('fk_artifacts_atlas_run_id_atlas_runs', type_='foreignkey')
    with op.batch_alter_table('artifacts') as batch_op:
        batch_op.create_foreign_key('fk_artifacts_atlas_run_id_atlas_runs', 'atlas_runs', ['atlas_run_id'], ['id'], ondelete='CASCADE')

    with op.batch_alter_table('evaluation_results') as batch_op:
        batch_op.drop_constraint('fk_evaluation_results_model_output_id_model_outputs', type_='foreignkey')
    with op.batch_alter_table('evaluation_results') as batch_op:
        batch_op.create_foreign_key('fk_evaluation_results_model_output_id_model_outputs', 'model_outputs', ['model_output_id'], ['id'], ondelete='CASCADE')

    with op.batch_alter_table('capability_profiles') as batch_op:
        batch_op.drop_constraint('fk_capability_profiles_atlas_run_id_atlas_runs', type_='foreignkey')
    with op.batch_alter_table('capability_profiles') as batch_op:
        batch_op.create_foreign_key('fk_capability_profiles_atlas_run_id_atlas_runs', 'atlas_runs', ['atlas_run_id'], ['id'], ondelete='CASCADE')

    with op.batch_alter_table('capability_scores') as batch_op:
        batch_op.drop_constraint('fk_capability_scores_capability_profile_id_capability_profiles', type_='foreignkey')
    with op.batch_alter_table('capability_scores') as batch_op:
        batch_op.create_foreign_key('fk_capability_scores_capability_profile_id_capability_profiles', 'capability_profiles', ['capability_profile_id'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('capability_scores') as batch_op:
        batch_op.drop_constraint('fk_capability_scores_capability_profile_id_capability_profiles', type_='foreignkey')
    with op.batch_alter_table('capability_scores') as batch_op:
        batch_op.create_foreign_key('fk_capability_scores_capability_profile_id_capability_profiles', 'capability_profiles', ['capability_profile_id'], ['id'])

    with op.batch_alter_table('capability_profiles') as batch_op:
        batch_op.drop_constraint('fk_capability_profiles_atlas_run_id_atlas_runs', type_='foreignkey')
    with op.batch_alter_table('capability_profiles') as batch_op:
        batch_op.create_foreign_key('fk_capability_profiles_atlas_run_id_atlas_runs', 'atlas_runs', ['atlas_run_id'], ['id'])

    with op.batch_alter_table('evaluation_results') as batch_op:
        batch_op.drop_constraint('fk_evaluation_results_model_output_id_model_outputs', type_='foreignkey')
    with op.batch_alter_table('evaluation_results') as batch_op:
        batch_op.create_foreign_key('fk_evaluation_results_model_output_id_model_outputs', 'model_outputs', ['model_output_id'], ['id'])

    with op.batch_alter_table('artifacts') as batch_op:
        batch_op.drop_constraint('fk_artifacts_atlas_run_id_atlas_runs', type_='foreignkey')
    with op.batch_alter_table('artifacts') as batch_op:
        batch_op.create_foreign_key('fk_artifacts_atlas_run_id_atlas_runs', 'atlas_runs', ['atlas_run_id'], ['id'])

    with op.batch_alter_table('model_outputs') as batch_op:
        batch_op.drop_constraint('fk_model_outputs_atlas_run_id_atlas_runs', type_='foreignkey')
    with op.batch_alter_table('model_outputs') as batch_op:
        batch_op.create_foreign_key('fk_model_outputs_atlas_run_id_atlas_runs', 'atlas_runs', ['atlas_run_id'], ['id'])

    with op.batch_alter_table('benchmark_lifecycles') as batch_op:
        batch_op.drop_constraint('fk_benchmark_lifecycles_benchmark_id_benchmarks', type_='foreignkey')
    with op.batch_alter_table('benchmark_lifecycles') as batch_op:
        batch_op.create_foreign_key('fk_benchmark_lifecycles_benchmark_id_benchmarks', 'benchmarks', ['benchmark_id'], ['id'])
