...
class ChartGenerator:
    ...
    def plot_prompt_comparison(self, exp_ids: List[str], pass_rates: List[float], filename="prompt_comparison.png"):
        fig, ax = plt.subplots(figsize=(8, 5))
    ...
    def plot_cluster_scatter(self, embeddings_2d: np.ndarray, labels: List[int], filename="cluster_scatter.png"):
        fig, ax = plt.subplots(figsize=(8, 6))
        scatter = ax.scatter(embeddings_2d[:, 0], embeddings_2d[:, 1], c=labels, cmap="Set1", alpha=0.7)
