...
def get_capability_query_service(repo: ReportingRepository = Depends(get_reporting_repository)) -> CapabilityQueryService:
    return CapabilityQueryService(repo)

def get_leaderboard_query_service(repo: ReportingRepository = Depends(get_reporting_repository)) -> LeaderboardQueryService:
    return LeaderboardQueryService(repo)
    
def get_history_query_service(repo: ReportingRepository = Depends(get_reporting_repository)) -> HistoryQueryService:
