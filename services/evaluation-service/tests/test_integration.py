...
from atlas_db.models.execution import AtlasRun, ModelOutput, RunStatus, EvaluationSession as ExecSession, ExecutionAdapter, ExecutionAdapterVersion
from atlas_db.models.evaluation import EvaluationJob, EvaluationAttempt, AttemptStatus, EvaluationResult, MetricValue, CapabilityProfile, CapabilityScore, EvaluationJobStatus
...
from app.pipelines.execution import ExecutionPipeline # Ensure registration
...
def test_evaluation_orchestrator(db_session):
    ...
    profile = db_session.query(CapabilityProfile).filter_by(adapter_version_id=adapter_version.id).one()
