...
class TestSearchService(unittest.TestCase):
    def setUp(self):
        self.r1 = SearchResult(id="1", entity_type="benchmark", title="B1", url="/b1", score=0.9)
        self.r2 = SearchResult(id="2", entity_type="execution", title="E1", url="/e1", score=0.5)
        self.r3 = SearchResult(id="3", entity_type="benchmark", title="B2", url="/b2", score=0.95)
