...
- `packages/llm/clients/gemini.py:list_models()` → `gemini-2.5-flash`, `gemini-3.1-flash-lite`
- `apps/backend/config.py:110` default → `gemini-2.5-flash`
- backend agent `state.py:155` default → `gemini-2.5-flash`
