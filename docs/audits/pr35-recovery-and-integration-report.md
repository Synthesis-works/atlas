...
- Agent run via the local UI: `gemini-1.5-flash` execution **COMPLETED** with real outputs; `grok-2-latest` failed honestly (provider 404 — stale registry name, see §10).
