...
- **Reason**: `run submit` defaulted to `gemini-3.6-flash` — a paid real-provider model an agent could submit "innocently". v2 requires an explicit model and offers a no-POST plan.
