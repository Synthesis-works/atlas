    ...
    for t_file in tasks:
        with open(t_file) as f:
            ...
            if t.get("status") == "PASS":
                passed += 1
            if (
                t.get("execution_status") == "success"
                or t.get("execution_status") != "extraction_failed"
            ):
                prompt_compliant += 1
...
def main():
    ...
    parser.add_argument(
        "--out",
        default="C:/Users/Sujal/.gemini/antigravity/brain/8b8c9560-c90d-4eb8-a62b-faba652acd87/report.md",
    )
