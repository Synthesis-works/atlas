...
def seed_billing():
    ...
    try:
        ...
        if not free_prod:
            free_prod = Product(
                name="Atlas Free", description="Basic features for everyone", is_active=True
            )
        ...
        if not pro_prod:
            pro_prod = Product(
                name="Atlas Pro", description="Advanced platform features", is_active=True
            )
        ...
        if not ent_prod:
            ent_prod = Product(
                name="Atlas Enterprise", description="Custom solutions and limits", is_active=True
            )
