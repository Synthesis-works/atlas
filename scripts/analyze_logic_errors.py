...
def main():
    ...
    parser.add_argument("--out", type=str, default="logic_errors_report.md", help="Output markdown file")
    ...
    logic_errors = [f for f in failures if f.get("evaluation_status") == "FAIL" or f.get("execution_status") == "ERROR"]
