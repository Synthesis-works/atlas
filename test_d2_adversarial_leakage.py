...
def test_leakage():
    ...
    with Session(engine) as session:
        ...
        assert ex.metadata == {"entry_point": "foo"}, "Metadata dictionary leaked forbidden structures!"
        ...
        leaked = False
        disallowed_strings = [
            "SECRET_SETUP", "SECRET_ASSERT", "DO_NOT_LEAK",
            "DO_NOT_LEAK_2", "DO_NOT_LEAK_3", "DO_NOT_LEAK_4", "DO_NOT_LEAK_5",
            "hidden_test_logic", "future_unknown_key", "grader_config"
        ]
